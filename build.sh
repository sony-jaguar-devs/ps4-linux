...
export KCFLAGS="-march=btver2 -mtune=btver2 -Os -fno-plt -fomit-frame-pointer -funroll-loops"
export KAFLAGS="-march=btver2 -mtune=btver2 -Os -fno-plt -fomit-frame-pointer -funroll-loops"
